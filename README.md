...
```css
@import url("https://cdn.jsdelivr.net/gh/StabiBerlin/design-tokens@v1.3.2/tokens.css");
```
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/gh/StabiBerlin/design-tokens@v1.3.2/tokens.css"
/>
```
